###ClouderaAutomate### Connection Object
...
###$SubscriptionId = bb548696-527d-45a9-ab30-c847b7dd3838
###$ApplicationDisplayName = ClouderaAppAutomation
###$ResourceGroup = met-inv-dev-usnc-cloudera-rg
...
Write-Host "Now Login to Azure using your CSP Credential"
Sleep 5
